...
namespace DragDrop_Event_ManagerForms_Square_Rectangle
{
    ...
    {
        public event DragDropEvent onDragDropEvent;
        public delegate void DragDropEvent(EventArgs args);
        ...
        {
            DragStartedEventArgs eventArgs = new DragStartedEventArgs();
            eventArgs.ucSender = this;
            onDragDropEvent?.Invoke(eventArgs);
        }
        ...
        {
            DragStartedEventArgs source = (DragStartedEventArgs)(e.Data.GetData(typeof(DragStartedEventArgs)));
            DragCompletedEventArgs eventArgs = new DragCompletedEventArgs();
            eventArgs.fromForm = source.formSender;
            eventArgs.fromUc = source.ucSender;
            eventArgs.toUc = this;
            onDragDropEvent?.Invoke(eventArgs);
        }
    }
